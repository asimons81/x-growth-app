...
const PROVIDERS = [
  {
    ...
    name: "Google Gemini",
    placeholder: "AIza...",
    description: "Default AI provider for all features",
    required: false,
    comingSoon: false,
  },
  {
    ...
    name: "OpenAI",
    placeholder: "sk-...",
    description: "GPT-4o for content generation",
    required: false,
    comingSoon: false,
  },
  {
    ...
    name: "Anthropic",
    placeholder: "sk-ant-...",
    description: "Claude for content generation",
    required: false,
    comingSoon: false,
  },
  {
  ...
  },
  {
    ...
    name: "MiniMax (Hailuo)",
    placeholder: "MX...",
    description: "MiniMax Hailuo API",
    required: false,
    comingSoon: false,
  },
  {
